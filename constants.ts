...
export const CONTENT: Record<string, Translations> = {
  en: {
    ...
    about: {
      title: 'About NicheDigger',
      subtitle: 'AI pSEO and GEO Automation Platform',
      back: 'Back to Home',
      description: {
        title: 'About NicheDigger',
        content: [
          'NicheDigger is an automated SaaS platform focused on AI pSEO and Generative Engine Optimization (GEO), dedicated to helping brands gain new growth opportunities in the AI search era.',
          'With the popularity of AI search tools like ChatGPT and Perplexity, traditional SEO is changing. NicheDigger automatically generates high-quality, well-structured landing pages that can be understood by search engines and large language models through AI agents, making websites more likely to be recommended by AI.',
          'Our goal is to enable anyone to obtain long-term, stable search traffic through AI automation without learning SEO.',
          'NicheDigger was founded by weihacking, headquartered in Guangzhou, China, serving users worldwide.',
        ],
      },
      contact: {
        title: 'Contact Us',
    ...
    faq: {
      title: 'NicheDigger Frequently Asked Questions',
      subtitle: 'Learn about AI pSEO, GEO, and how to get search traffic through automated page generation',
      back: 'Back to Home',
      questions: [
        {
          question: 'What is AI pSEO?',
          answer: 'AI pSEO refers to the automated generation of large-scale, structured pages that can be understood by search engines and AI, used to cover long-tail search needs and obtain stable traffic.',
        },
        {
          question: 'How is NicheDigger different from traditional SEO?',
          answer: 'Traditional SEO relies on manual keyword selection, content writing, and structure optimization. NicheDigger automatically completes keyword analysis, page generation, and content structure optimization through AI agents, allowing users to use it without any SEO experience.',
        },
        {
          question: 'What is GEO (Generative Engine Optimization)?',
          answer: 'GEO is an optimization method for generative search engines like ChatGPT, Perplexity, Gemini, etc. The goal is to make your pages easier for AI to understand, reference, and recommend.',
        },
        {
          question: 'Who is NicheDigger suitable for?',
          answer: 'Suitable for SaaS entrepreneurs, independent developers, content site owners, marketers, and any brand that wants to obtain natural traffic through AI search.',
        },
        {
          question: 'Do I need to learn SEO to use NicheDigger?',
          answer: 'No. The core philosophy of NicheDigger is "no need to learn SEO". The system automatically completes page structure, content, and optimization logic.',
        },
      ],
    },
  },
  cn: {
    ...
    about: {
      title: '关于 NicheDigger',
      subtitle: 'AI pSEO 与 GEO 自动化平台',
      back: '返回首页',
      description: {
        title: '关于 NicheDigger',
        content: [
          'NicheDigger 是一个专注于 AI pSEO 与生成式引擎优化（GEO）的自动化 SaaS 平台，致力于帮助品牌在 AI 搜索时代获得新的增长机会。',
          '随着 ChatGPT、Perplexity 等 AI 搜索工具的普及，传统 SEO 正在发生改变。NicheDigger 通过 AI 代理自动生成高质量、结构清晰、可被搜索引擎与大模型理解的导流页面，让网站更容易被 AI 推荐。',
          '我们的目标是：让任何人无需学习 SEO，也能通过 AI 自动化获取长期、稳定的搜索流量。',
          'NicheDigger 由 weihacking 创立，总部位于中国广州，服务全球用户。',
        ],
      },
      contact: {
        title: '联系我们',
    ...
    faq: {
      title: 'NicheDigger 常见问题',
      subtitle: '了解 AI pSEO、GEO 以及如何通过自动生成页面获取搜索流量',
      back: '返回首页',
      questions: [
        {
          question: '什么是 AI pSEO？',
          answer: 'AI pSEO 是指通过人工智能自动生成大规模、结构化、可被搜索引擎和 AI 理解的页面，用于覆盖长尾搜索需求并获取稳定流量。',
        },
        {
          question: 'NicheDigger 和传统 SEO 有什么不同？',
          answer: '传统 SEO 依赖人工选词、写内容和优化结构。NicheDigger 通过 AI 代理自动完成关键词分析、页面生成与内容结构优化，用户无需任何 SEO 经验即可使用。',
        },
        {
          question: '什么是 GEO（生成式引擎优化）？',
          answer: 'GEO 是针对 ChatGPT、Perplexity、Gemini 等生成式搜索引擎的优化方式，目标是让你的页面更容易被 AI 理解、引用和推荐。',
        },
        {
          question: 'NicheDigger 适合哪些用户？',
          answer: '适合 SaaS 创业者、独立开发者、内容站站长、营销人员，以及任何希望通过 AI 搜索获取自然流量的品牌。',
        },
        {
          question: '需要学习 SEO 才能使用 NicheDigger 吗？',
          answer: '不需要。NicheDigger 的核心理念是"无需学习 SEO"，系统会自动完成页面结构、内容与优化逻辑。',
        },
      ],
    },
  },
