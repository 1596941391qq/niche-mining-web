...
const GoogleMinerGraphic = () => (
  ...
  >
    ...
    <path
      d="M40 140 L100 170 L160 140 L100 110 Z"
      fill="#18181b"
      stroke="#10b981"
      strokeWidth="2"
    />
    <path
      d="M40 140 L40 155 L100 185 L160 155 L160 140"
      fill="none"
      stroke="#10b981"
      strokeWidth="2"
      strokeDasharray="4 4"
    ...
    {/* Main Body Block */}
    <path
      d="M60 120 L120 150 L120 90 L60 60 Z"
      fill="url(#grad1)"
      stroke="#10b981"
      strokeWidth="2"
    />
    <path
      d="M120 150 L140 140 L140 80 L120 90"
      fill="#27272a"
      stroke="#10b981"
      strokeWidth="2"
    />
    <path
      d="M60 60 L120 90 L140 80 L80 50 Z"
      fill="#10b981"
      fillOpacity="0.2"
      stroke="#10b981"
      strokeWidth="2"
  ...
  >
    <defs>
      <radialGradient id="grad2" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
        ...
        <stop
          offset="100%"
          style={{ stopColor: "#10b981", stopOpacity: 0.0 }}
        />
      </radialGradient>
    </defs>
...
const BingDroneGraphic = () => (
  ...
  >
    ...
    {/* Central Core */}
    <path
      d="M100 140 L130 120 L130 80 L100 60 L70 80 L70 120 Z"
      fill="#18181b"
      stroke="#10b981"
      strokeWidth="2"
    />
    <path
      d="M70 80 L100 100 L130 80"
      fill="none"
      stroke="#10b981"
      strokeWidth="1"
    />
    ...
    {/* Wings/Rotors */}
    <path
      d="M70 90 L40 80 L40 100 L70 110"
      fill="rgba(16,185,129,0.1)"
      stroke="#10b981"
      strokeWidth="1"
    />
    <path
      d="M130 90 L160 80 L160 100 L130 110"
      fill="rgba(16,185,129,0.1)"
      stroke="#10b981"
      strokeWidth="1"
    />
...
const ToolSelector: React.FC = () => {
  ...
  const getGraphic = (id: string) => {
    switch (id) {
      case "google":
        return <GoogleMinerGraphic />;
      case "yandex":
        return <YandexRadarGraphic />;
      case "bing":
        return <BingDroneGraphic />;
      default:
        return <GoogleMinerGraphic />;
    }
  };
  ...
  const handleToolClick = async (
    ...
    // 检查 agent 是否可用（所有 agent 都已启用）
    const availableAgents = ["google", "yandex", "bing"];
                ...
                <div className="p-8 flex-1 flex flex-col relative bg-zinc-900/20">
                  ...
                  <div className="space-y-4 mb-8 flex-1">
                    {tool.features.map((feat, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 text-xs font-mono text-zinc-300"
                      >
