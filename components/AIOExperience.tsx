      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16 lg:mb-24">
          {t.howItWorks.trends.stats.map((stat, idx) => (
            <div
              key={idx}
              className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-sm hover:border-primary/50 transition-all group"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#0c0c0e] border border-zinc-800 rounded-sm overflow-hidden shadow-2xl">
              ...
              <div className="p-8 font-sans text-zinc-300">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#0c0c0e] border border-zinc-800 rounded-sm overflow-hidden shadow-2xl">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-8 bg-zinc-900 p-3 rounded-sm border border-zinc-800">
