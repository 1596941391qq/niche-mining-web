  ...
  const plans = [
    {
      ...
      description:
        lang === "cn"
          ? "注册即送，足够完成 2 篇全链路内容测试。"
          : "Claim on registration, enough for 2 full-link content tests.",
      credits: "200",
      features:
        lang === "cn"
          ? [
          ...
          : [
              "200 Free Production Credits",
              "Full-link Pipeline Access",
    ...
    },
    {
      ...
      description:
        lang === "cn"
          ? "适合个人站长，产出 20 篇高权重图文或挖掘 1000 个词。"
          : "Perfect for solopreneurs, output 20 high-weight articles or mine 1000 keywords.",
      credits: "2,000",
      features:
        lang === "cn"
          ? [
          ...
          : [
              "2,000 Production Credits",
              "Priority Production Queue",
              "Advanced AIO/GEO Optimization",
              "Visual Fingerprint System",
              "Priority Support",
            ],
    ...
    },
    {
      ...
      description:
        lang === "cn"
          ? "内容帝国基石，产出 100 篇全链路内容。"
          : "The foundation of your content empire, output 100 full-link contents.",
      credits: "10,000",
      features:
        lang === "cn"
          ? [
          ...
          : [
              ...
              "Dedicated Compute Channel",
              "Deep Market Vacuum Scanning",
              "Unlimited Asset-grade Visuals",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 lg:mb-6 font-mono tracking-tight">
            {lang === "cn"
              ? "投资方案 (The Investment Plans)"
              : "The Investment Plans"}
          </h2>
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto font-mono">
            {lang === "cn"
              ? "停止无效支出，开始为确定性收益投资。"
              : "Stop wasting budget, start investing in certainty."}
          </p>
        </div>
          ...
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <button
                ...
                className={`w-full py-4 font-bold text-sm uppercase tracking-widest transition-all rounded-sm group-hover:shadow-lg ${
                  plan.color === "orange"
                  ...
                  paymentLoading === plan.id ? "opacity-50 cursor-wait" : ""
                }`}
              >
